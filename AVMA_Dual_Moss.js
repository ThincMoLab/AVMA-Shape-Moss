...
Ready? Press (H, U, I, or L) to continue.`
    ...
    if ((training_vol === 'Minimum' && session === 1) || (training_vol === 'Extensive' && session === 3)) {
      instr_rt_new_text = `In the following block, you are going to use the new symbol-key map you learned. 
...
Whenever you are ready, press (H, U, I, or L) to start.`
        ...
        if ((session === 2)) {
            instr_rt_text = `Now, we continue to practice the symbol-key maps for ${rt_block} blocks.
...
Whenever you are ready, press (H, U, I, or L) to start.`
    ;
            ...
            if (session === 3){
              instr_rt_text = `Now we continue to practice the symbol-key map you did yesterday for ${rt_block} block.
