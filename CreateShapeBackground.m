...
%% ========================================================================
%  CREATE 4-SQUARE BACKGROUND - SIZE CORRECTED
%% ========================================================================
...
x_mean = mean(positions(:,1));
positions(:,1) = positions(:,1) - x_mean;
...
output_file = 'shape_right_background.png';
output_folder = './media/';
...
img_left = fliplr(img);   % <-- THIS is the key operation

output_file_left = 'shape_reverse_background.png';
output_path_left = fullfile(output_folder, output_file_left);

imwrite(img_left(:,:,1:3), output_path_left, ...
        'png', 'Alpha', img_left(:,:,4));

fprintf('✅ Left-hand image created!\n');
fprintf('   Path: %s\n', output_path_left);
